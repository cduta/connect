...
impl State {
  ...
  fn move_shape(tx                     : &duckdb::Transaction,
    ...
    fn change_shape<F>(mut f: F, tx: &duckdb::Transaction, shape: i32, here_shape: Vec<Object>, there: (u16, u16)) -> MoveObjectResult
    where F: FnMut() -> duckdb::Result<()> {
